<template>
  <footer class="flex flex-col sm:flex-row container mx-auto px-5 py-5">
    ...
    <ul class="flex flex-none mx-auto mt-3">
      <li>
        <a
          href="https://github.com/LloydTao/"
          class="text-gray-300 hover:text-gray-400 text-sm block py-1 px-3"
          >GitHub</a
        >
      </li>
      <li>
