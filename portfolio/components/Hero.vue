<template>
  <div class="flex flex-col lg:flex-row items-center">
    <div class="flex flex-col lg:w-1/2 pr-5">
      ...
      <p class="text-xl text-gray-200 mt-5">
      ...
      <div class="space-x-3 mt-8">
        <a href="https://github.com/LloydTao">
          <button
            type="button"
            class="shadow-md py-3 px-5 bg-github-primary hover:bg-github-darker rounded"
          >
        ...
        <a href="https://twitter.com/LloydTao">
          <button
            type="button"
            class="shadow-md py-3 px-5 bg-twitter-primary hover:bg-twitter-darker rounded"
          >
            <div class="flex items-center text-white space-x-3">
              <svg
                viewBox="0 0 24 24"
    ...
    <div class="flex rounded shadow lg:w-1/2 mt-5 overflow-hidden">
      <div>
        <img
